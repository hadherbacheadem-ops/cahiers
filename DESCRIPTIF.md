...
- **Carte mentale à trous / reconstruction** : chaque carte de fiche crée deux exercices planifiés — retrouver 30 à 50 % des nœuds masqués (masque différent à chaque révision), ou reconstruire les sous-nœuds de chaque branche de mémoire puis comparer. Lire la carte reste possible mais n'est plus une révision.
- **Saisie de la réponse** : les flashcards marquées « à saisir » (formules, valeurs) ou toutes si le réglage est activé demandent d'écrire la réponse avant la révélation ; comparaison tolérante (casse, accents, écritures LaTeX équivalentes) avec diff mot à mot, note suggérée, décision finale à l'élève.
